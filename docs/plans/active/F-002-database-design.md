...
* Question Entity：通过
* KnowledgePoint Entity：通过
* QuestionRepository：通过
* KnowledgePointRepository：通过
* KnowledgePoint parent 自关联：通过
* Question-KnowledgePoint 多对多：通过
...
* Question.subject 必须与关联 KnowledgePoint 所属知识树一致
