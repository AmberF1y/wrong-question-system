...
```text
feature/F-009-math-formula-rendering
```

F-009 从 `main@62cd59f` 创建功能分支，只修改前端展示、测试和文档。当前已
加入 KaTeX、共享数学文本组件、表单说明与预览，并接入错题列表、详情和每日
复习。前端 17 个测试文件、113 个测试、TypeScript 类型检查、生产构建和后端
146 个测试已通过；用户已完成真实浏览器人工验收，因此状态为 Completed，计划
归档于 `docs/plans/completed/F-009-math-formula-rendering.md`。
